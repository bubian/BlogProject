...
Java_com_pds_facerecognition_MainActivity_loadModel(JNIEnv *env, jobject instance,
...
Java_com_pds_facerecognition_MainActivity_process(JNIEnv *env, jobject instance,
                                                               jobject bitmap) {
...
JNIEXPORT void JNICALL
Java_com_pds_facerecognition_MainActivity_setSurface(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_com_pds_facerecognition_MainActivity_destroy(JNIEnv *env, jobject instance) {
