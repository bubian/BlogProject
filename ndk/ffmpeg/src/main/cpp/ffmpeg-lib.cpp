...
Java_md_edu_pds_kt_ffmpeg_DavidPlayer_release(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_md_edu_pds_kt_ffmpeg_DavidPlayer_display(JNIEnv *env, jobject instance, jobject surface) {
    if (window) {
...
extern "C"
JNIEXPORT void JNICALL
 Java_md_edu_pds_kt_ffmpeg_DavidPlayer_play(JNIEnv *env, jobject instance, jstring path_) {
