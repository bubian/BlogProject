...
Java_com_pds_gif_GifHandler_loadPath(JNIEnv *env, jobject instance, jstring path_) {
...
Java_com_pds_gif_GifHandler_getWidth(JNIEnv *env, jobject instance, jlong ndkGif) {
...
JNIEXPORT jint JNICALL
Java_com_pds_gif_GifHandler_updateFrame(JNIEnv *env, jobject instance, jlong ndkGif,
                                                      jobject bitmap) {
    //强转代表gif图片的结构体
    GifFileType *gifFileType= (GifFileType *)ndkGif;
