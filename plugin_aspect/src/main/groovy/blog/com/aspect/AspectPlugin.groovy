...
//            debugCompile 'com.lib:aspect-runtime:1.0.0'
        ...
        variants.all { variant ->
            if (!variant.buildType.isDebuggable()) {
                ...
                return
            } else if (!project.aspect.enabled) {
                log.debug("aspect is not disabled.")
                return
            }
            ...
            javaCompile.doLast {
                String[] args = [
                        ...
                        "-bootclasspath", project.android.bootstrapClasspath.join(File.pathSeparator)
                ]
