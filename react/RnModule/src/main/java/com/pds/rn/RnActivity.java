...
import com.pds.rn.rectactivity.BaseRnActivity;
 ...
 * @author pengdaosong
 */
@Route(path = ModuleGroupRouter.RN_ACTIVITY)
public class RnActivity extends BaseRnActivity {
    ...
    private static void launchReactActivity(String module,String route,Bundle bundle){
        launchReactActivity(ModuleRn.instance().appContext(),module,route,bundle,USELESS_REQUEST_CODE);
    }
