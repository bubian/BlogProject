  ...
  void _selectValue(value) {
    if (value == 'doc') {
      ...
      Application.router.navigateTo(context,
          '${Routers.webViewPage}?title=${Uri.encodeComponent(widget.title)} Doc&&url=${Uri.encodeComponent(widget.docUrl)}');
    } else if (value == 'code') {
      Application.router.navigateTo(context,
          '${Routers.codeView}?filePath=${Uri.encodeComponent(widget.codeUrl)}');
    }
  }
