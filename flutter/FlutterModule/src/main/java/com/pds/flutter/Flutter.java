...
public final class Flutter {
  ...
  /**
   * Creates a {@link FFragment} managing a {@link FlutterView}. The optional
   ...
   * @return a {@link FFragment}
   */
  @NonNull
  public static FFragment createFragment(String initialRoute) {
    final FFragment fragment = new FFragment();
    final Bundle args = new Bundle();
    args.putString(FFragment.ARG_ROUTE, initialRoute);
