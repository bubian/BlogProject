...
public class CustomVerticalCenterSpan extends ReplacementSpan {
    ...
    private TextPaint getCustomTextPaint(Paint srcPaint) {
        ...
        paint.setTextSize(UnitConversionUtils.sp2Px(BlogApplication.instance(), fontSizeSp));   //设定字体大小, sp转换为px
        return paint;
    }
     ...
     * @return
     */
    public static SpannableString toxString(int num) {
        SpannableString spannableString = new SpannableString("x " + String.valueOf(num));
        spannableString.setSpan(new CustomVerticalCenterSpan(15), 0, 1, Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
