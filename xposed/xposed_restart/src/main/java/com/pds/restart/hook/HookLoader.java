...
public class HookLoader implements IXposedHookLoadPackage {
     ...
     */
    private final String modulePackage = "com.pds.restart";
    /**
    ...
    static {
        ...
        hostAppPackages.add("com.pds.xposed.hook");
    }

    /**
     * 实际hook逻辑处理类 TODO 需要配置
     */
    private final String handleHookClass = RealHook.class.getName();
    /**
     * 实际hook逻辑处理类的入口方法
     */
