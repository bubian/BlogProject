...
public class XdBufferedInputStream extends FilterInputStream {
	/**
	 ...
	 */
	public XdBufferedInputStream(InputStream in) {
		this(in, 8192);
	}
	 ...
	 */
	public XdBufferedInputStream(InputStream in, int size) {
		super(in);
		if (size <= 0) {
