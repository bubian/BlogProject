package com.pds.ui.jsonviewer.adapter;
...
import com.pds.ui.jsonviewer.utils.Utils;
import com.pds.ui.jsonviewer.view.JsonDialog;
import com.pds.ui.jsonviewer.view.JsonItemView;
...
//        }
    ...
    class JsonItemClickListener implements View.OnClickListener {
        ...
        JsonItemClickListener(Object value, JsonItemView itemView, boolean appendComma, int hierarchy, String keyValue) {
            this.value = value;
        ...
        public void onClick(View view) {
            if (isPrimitiveAndString(value)) {
                ...
                JsonDialog moreMenuDialog = new JsonDialog();
                mBundle.putString("json_key_value", keyValue);
                moreMenuDialog.setArguments(mBundle);
                moreMenuDialog.show(((FragmentActivity) view.getContext()).getSupportFragmentManager(), "json");
                return;
            }
    ...
    private boolean isPrimitiveAndString(Object value) {
