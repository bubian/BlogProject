...
//            layoutParams.height = dm.widthPixels * 3 / 5;
            ...
            layoutParams.width = UnitConversionUtils.dip2px(getContext(),270);
            layoutParams.height = UnitConversionUtils.dip2px(getContext(),265);
            layoutParams.gravity = Gravity.CENTER;
            getDialog().setCanceledOnTouchOutside(false);
        } else if (mType == 6) {
            layoutParams.width = UnitConversionUtils.dip2px(getContext(),270);
            layoutParams.height = UnitConversionUtils.dip2px(getContext(),372.5f);
            layoutParams.gravity = Gravity.CENTER;
            getDialog().setCanceledOnTouchOutside(true);
        } else if (mType == 7) {
            layoutParams.width = UnitConversionUtils.dip2px(getContext(),302f);
            layoutParams.height = UnitConversionUtils.dip2px(getContext(),216.5f);
            layoutParams.gravity = Gravity.CENTER;
            getDialog().setCanceledOnTouchOutside(true);
        }
