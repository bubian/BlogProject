 ...
 */
public class SmoothLinePageIndicator extends RoundRectView implements PageIndicator {
    ...
    public SmoothLinePageIndicator(Context context) {
        this(context, null);
    }

    public SmoothLinePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiLinePageIndicatorStyle);
    }

    public SmoothLinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        android.graphics.drawable.Drawable background = a.getDrawable(R.styleable.LinePageIndicator_android_background);
        if (background != null) {
