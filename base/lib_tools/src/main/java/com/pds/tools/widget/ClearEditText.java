...
import android.widget.AutoCompleteTextView;;import com.pds.tools.R;
...
public class ClearEditText extends AutoCompleteTextView implements
    ...
    private void init() {
        ...
        setCompoundDrawablePadding(getContext().getResources().getDimensionPixelSize(R.dimen.dp_10));
