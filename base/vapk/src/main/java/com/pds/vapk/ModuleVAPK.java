 ...
 * @Description:
 */
public class ModuleVAPK {
    public ModuleVAPK mModuleStorage;
    ...
    public static final ModuleVAPK instance() {
        return Lazy.INSTANCE;
    }

    private static final class Lazy {
        private static final ModuleVAPK INSTANCE = new ModuleVAPK();
    }
