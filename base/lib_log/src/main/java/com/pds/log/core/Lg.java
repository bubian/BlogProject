...
public final class Lg {
    ...
    private static final String TAG_DEFAULT = "NULL_LOG";
    ...
    public static void init(boolean enable, @Nullable String tag) {
        sEnable = enable;
        mGlobalTag = TextUtils.isEmpty(tag) ? TAG_DEFAULT : tag;
    }
