...
import com.pds.edit.core.sticker.IMGStickerAdjustHelper;
import com.pds.edit.core.sticker.IMGStickerHelper;
import com.pds.edit.core.sticker.IMGStickerMoveHelper;
...
public abstract class IMGStickerView extends ViewGroup implements IMGSticker, View.OnClickListener {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        rectF.left = getX() + getPaddingLeft();
        rectF.top =  getY() + getPaddingTop() ;
        rectF.right = rectF.left + getWidth();
        rectF.bottom = rectF.top + getHeight();

        boolean handled = mMoveHelper.onTouch(this, event,imageRect,rectF);
