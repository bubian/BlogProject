        ...
        contentAdapter.apply {
            ...
            setItemChildOnClickListener(object : SimpleItemOnClickListener<Entity>() {
                override fun onItemClick(v: View?, position: Int, data: Entity?) {
                    val clz = if (
                        R.layout.barrier_1 == data?.layoutId
                        || R.layout.constraint_7 == data?.layoutId
                        || data?.layoutId == R.layout.template_impl) ConstraintActivity::class.java else ConstraintLayoutActivity::class.java
                    AnkoInternals.internalStartActivity(this@ConstraintMainActivity,clz, arrayOf(Pair("layout_id", data?.layoutId),
    ...
    inner class ContentAdapter(context: Context) : ListAdapter<Entity>(context){
        ...
        private fun createTextView(context: Context) : View {
            ...
            return Button(context).apply {
                ...
                setBackgroundResource(R.drawable.bg_rect_008577_20)
