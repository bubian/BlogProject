package com.pds.kotlin.study.ui.view
...
class CustomView3 @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private val bitmap1: Bitmap = BitmapFactory.decodeResource(resources, R.drawable.batman)
    private val bitmap2: Bitmap = BitmapFactory.decodeResource(resources, R.drawable.batman_logo)
