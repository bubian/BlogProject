package com.pds.sample.module.skin.widget;
...
public class SkinCircleView extends View implements SkinViewSupport {
    ...
    public SkinCircleView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SkinCircleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.attrs = attrs;
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinCircleView);
        corcleColorResId = typedArray.getResourceId(R.styleable.SkinCircleView_corcleColor, 0);
        typedArray.recycle();
        mTextPain = new Paint();
